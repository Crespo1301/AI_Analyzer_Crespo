# Week 2, Game 15: Indianapolis Colts at Kansas City Chiefs (SNF)

- Kickoff: 2026-09-20, 8:20 AM ET (Sunday)
- Venue: GEHA Field at Arrowhead Stadium, Kansas City MO
- Network: NBC
- Lane: forced-selection v3.2 (independent-derivation, self-record)

Feed the same prompt below to Claude, Codex, and Gemini. Claude and Codex write their responses directly to disk under `Docs/Responses/2026/week-02/game-15-colts-chiefs/`. Gemini returns its full response in the chat because its web app cannot write to the repo. Do not add "Grading concerns" as a separate corrections doc, keep any inline.

## The prompt (copy from here down)

```text
You are an independent entry in the CSolutions AI Analyzer NFL
study, Week 2, Indianapolis Colts at Kansas City Chiefs. Kickoff 2026-09-20 8:20 AM ET at
GEHA Field at Arrowhead Stadium, Kansas City MO, broadcast on NBC. game_id: colts-chiefs.
...
WHERE TO PUT YOUR RESPONSE
  - If you can write to the repository filesystem (Claude via
    ...
    `Docs/Responses/2026/week-02/game-15-colts-chiefs/<model>-picks.md`
  ...
  - If you cannot write to the repository (Gemini web app):
    ...
    `Docs/Responses/2026/week-02/game-15-colts-chiefs/gemini-picks.md`
...
7. One valid JSON object with fields:
   ...
   game_id ("colts-chiefs"), forced_allocation (true),
