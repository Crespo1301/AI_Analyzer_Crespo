...
Feed the same prompt below to Claude, Codex, and Gemini. Claude and Codex write their responses directly to disk under `Docs/Responses/2026/week-02/game-10-jaguars-broncos/`. Gemini returns its full response in the chat because its web app cannot write to the repo. Do not add "Grading concerns" as a separate corrections doc, keep any inline.
...
WHERE TO PUT YOUR RESPONSE
  - If you can write to the repository filesystem (Claude via
    ...
    `Docs/Responses/2026/week-02/game-10-jaguars-broncos/<model>-picks.md`
  ...
  - If you cannot write to the repository (Gemini web app):
    ...
    `Docs/Responses/2026/week-02/game-10-jaguars-broncos/gemini-picks.md`
...
7. One valid JSON object with fields:
   ...
   game_id ("jaguars-broncos"), forced_allocation (true),
