...
Project: AI Analyzer
Purpose: NFL and sports-prediction model comparison project, rebuilt as a professional seasonal credibility asset.
Voice: Curious, evidence-first, and self-led. Avoid pretending this is current academic research. Frame it as a serious personal project revisited ahead of the NFL season.
