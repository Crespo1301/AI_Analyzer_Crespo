...
Projected winner: **Chiefs**. Projected script: a controlled favorite win with enough offense to challenge 43.5. Full $20 allocation: $14 straight spread target and $6 SGP.
...
```json
{
  ...
  "team_profiles_read": [
    {
      "path": "Data/2026/rosters/denver-broncos.json",
      "as_of": "2026-09-13",
    ...
    {
      "path": "Data/2026/rosters/kansas-city-chiefs.json",
      "as_of": "2026-09-13",
      "season_record": "0-0, 0 games, 0 PF, 0 PA",
      "health_key_players": [
        "OT Josh Simmons",
  ...
  "bets": [
    {
      ...
      "reason_wins": "Chiefs has the stronger researched matchup and roster context.",
    ...
    },
    {
      "type": "parlay",
      "market": "SGP",
      "line": "Chiefs moneyline + OVER 43.5 total points",
      "stake": 6.0,
      "pricing_status": "conditional",
      "odds_american": null,
      ...
      "reason_wins": "A controlled Chiefs win is compatible with the over 43.5 script.",
  ...
  "sources": [
    ...
    },
    {
      ...
      "fetch_succeeded": true,
      "excerpt": "FanDuel matchup market lists Kansas City Chiefs -2.5 and total 43.5."
    },
    {
  ...
  "reasoning_summary": "Pregame eligibility is active. FanDuel provided market context for Kansas City Chiefs -2.5 and total 43.5; Bovada did not expose an event-specific quote. The forced allocation uses a $14 conditional spread target and $6 conditional SGP, with no props or Bovada verification claim."
}
```
