...
Projected winner: **Raiders**. Projected script: a controlled favorite win with enough offense to challenge 39.5. Full $20 allocation: $14 straight spread target and $6 SGP.
...
```json
{
  ...
  "team_profiles_read": [
    {
      "path": "Data/2026/rosters/miami-dolphins.json",
      "as_of": "2026-09-13",
    ...
    {
      "path": "Data/2026/rosters/las-vegas-raiders.json",
      "as_of": "2026-09-13",
      "season_record": "0-0, 0 games, 0 PF, 0 PA",
      "health_key_players": [
        "TE Brock Bowers"
  ...
  "bets": [
    {
      ...
      "reason_wins": "Raiders has the stronger researched matchup and roster context.",
    ...
    },
    {
      "type": "parlay",
      "market": "SGP",
      "line": "Raiders moneyline + OVER 39.5 total points",
      "stake": 6.0,
      "pricing_status": "conditional",
      "odds_american": null,
      ...
      "reason_wins": "A controlled Raiders win is compatible with the over 39.5 script.",
  ...
  "sources": [
    ...
    {
      "url": "https://www.fanduel.com/research/raiders-vs-dolphins-predictions-odds-best-bets-for-nfl-week-1-2026",
      "fetch_succeeded": true,
      "excerpt": "FanDuel matchup market lists Las Vegas Raiders -3 and total 39.5."
    },
    {
  ...
  "reasoning_summary": "Pregame eligibility is active. FanDuel provided market context for Las Vegas Raiders -3 and total 39.5; Bovada did not expose an event-specific quote. The forced allocation uses a $14 conditional spread target and $6 conditional SGP, with no props or Bovada verification claim."
}
```
