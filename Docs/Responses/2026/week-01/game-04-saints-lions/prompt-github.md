# GitHub-access prompt v3.0, Week 1 Game 4: New Orleans Saints at Detroit Lions

For: Gemini, or any model without local filesystem access.
Kickoff: 2026-09-13 1:00 PM ET at Ford Field, FOX.
...
study, Week 1, New Orleans Saints at Detroit Lions. Kickoff 2026-09-13 1:00 PM ET at Ford Field,
broadcast on FOX. game_id: saints-lions.
...
- https://raw.githubusercontent.com/Crespo1301/AI_Analyzer_Crespo/main/Data/2026/rosters/new-orleans-saints.json
...
7. One valid JSON object with fields:
   ...
   game_id ("saints-lions"), forced_allocation (true), bankroll (20),
